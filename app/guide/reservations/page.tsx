                ...
                <CardContent className="p-0">
                  <div className="p-4">
                    ...
                    <div className="grid grid-cols-3 gap-3 rounded-lg bg-muted/50 p-3">
                      <div>
                        ...
                        <p className="mt-0.5 font-medium text-foreground">{booking.date}</p>
                      </div>
                      <div>
                        <p className="text-xs uppercase tracking-wide text-muted-foreground">Time</p>
                        <p className="mt-0.5 font-medium text-foreground">{booking.time}</p>
                      </div>
                      <div>
                        <p className="text-xs uppercase tracking-wide text-muted-foreground">Guests</p>
                        <p className="mt-0.5 font-medium text-foreground">{booking.guestDetails}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between border-t border-border bg-muted/30 px-4 py-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-foreground">{booking.leadTraveler}</p>
